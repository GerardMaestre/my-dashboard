...
if '%errorlevel%' EQU '0' (
    echo [! NEXUS -> ERROR] ERROR: Spicetify NO debe ser ejecutado como Administrador.
    echo [I] Por favor, ejecuta este script de forma normal.
    pause
    exit /B
)

echo [⚡ NEXUS] Cerrando Spotify de forma forzada para evitar errores...
taskkill /F /IM Spotify.exe >nul 2>&1

echo [⚡ NEXUS] Descargando el nucleo de Spicetify CLI...
powershell.exe -Command "iwr -useb https://raw.githubusercontent.com/spicetify/spicetify-cli/master/install.ps1 | iex"

echo [⚡ NEXUS] Descargando la tienda de complementos (Marketplace)...
...
echo [⚡ NEXUS] Aplicando el plugin de Letras (Lyrics-Plus)...
powershell.exe -Command "spicetify config custom_apps lyrics-plus"

echo [⚡ NEXUS] Horneando e inyectando tema en Spotify...
powershell.exe -Command "spicetify backup apply"

echo.
echo ⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS =====
echo [✔ NEXUS -> COMPLETADO] Spicetify instalado. Abre Spotify para ver la magia.
echo ⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS ====⚡ ==== NEXUS =====
pause